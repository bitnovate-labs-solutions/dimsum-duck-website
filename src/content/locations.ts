...
export const locations: Location[] = [
  ...
  },
  {
    ...
    streetAddress: "124 King's Cross Road",
    addressLocality: "London",
    postalCode: "WC1X 9DS",
    addressCountry: "GB",
    geo: { latitude: 51.53025, longitude: -0.11641 },
    googleMapsUrl: "https://share.google/L9wacmkOhq1y9uKet",
    heroImage: pageHeroImage("kings-cross-road"),
    introImage: dsdImage("Dim Sum Duck 090426-3587.webp"),
    introImageAlt: "Dim Sum Duck King's Cross Road dining room",
    gallery: [
      {
        src: dsdImage("Dim Sum Duck 090426-3592.webp"),
      ...
      {
        src: dsdImage("Dim Sum Duck 090426-2450.webp"),
      ...
      {
        src: dsdImage("Dim Sum Duck 090426-3449.webp"),
